...
export default function Footer() {
  return (
    <div className='logos-container grid h-full grid-cols-5 grid-rows-6'>
      <div className='col-span-5 col-start-1 row-start-1 h-[50%] bg-gradient-to-b from-slate-400'>
        <Image
      ...
      <div className='z-10 col-span-1 col-start-1 row-span-full select-none transition-colors hover:bg-[hsla(324,98%,40%,0.12)]'></div>
      ...
      <div className='z-10 col-span-1 col-start-2 row-span-full select-none transition-colors hover:bg-[hsla(324,98%,40%,0.12)]'></div>
      ...
      <div className='z-10 col-span-1 col-start-4 row-span-full select-none transition-colors hover:bg-[hsla(324,98%,40%,0.12)]'></div>
      ...
      <div className='z-10 col-span-1 col-start-5 row-span-full select-none transition-colors hover:bg-[hsla(324,98%,40%,0.12)]'></div>
